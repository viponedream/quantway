...
class IBWrapper(EWrapper):
    ...
    def error(self, id, errorCode, errorString):
        ...
        """
        print "error code %d:%s" % (errorCode, errorString)
        """
    ...
    def updateAccountTime(self, timeStamp):
        print "updateAccountTime %s" % timeStamp
        pass
    ...
    def accountSummary(self, reqId, account, tag, value, curency):
        print "accountSummary reqId:%d, account: %s, tag: %s, value: %s, curency: %s" % (reqId, account, tag, value, curency)
    ...
    def updateAccountValue(self, key, value, currency, accountName):
        ...
        """
        print "updateAccountValue key: %s, value: %s, currency: %s, accountName: %s" % (key, value, currency, accountName)
...
class IBclient(object):
    ...
    """
    def __init__(self, callback, accountid="U8903760"):
        """
        Create like this
        callback = IBWrapper()
        client=IBclient(callback)
    ...
    def req_account_summary(self, reqId=MEANINGLESS_NUMBER):
        self.cb.init_portfolio_data()
        self.cb.init_error()

        ## Turn on the streaming of accounting information
        self.tws.reqAccountSummary(reqId, 'All', 'AccountType,TotalCashValue,BuyingPower')
